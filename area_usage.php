...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($letterhead['error'] != 0 || $display['error'] != 0){
        ...
        function uploadFile($file,$doc_type,$request_id,$conn){
            ...
            $path = "uploads/area_usage/".$filename;
        ...
        $success = "Area usage request submitted successfully.";
    }
}
...
<title>Area Usage Request</title>
...
<h1>Area Usage Permission</h1>

<div class="note">
To use public areas like Refugee, Entrance, or Canopy, upload:<br><br>

• Letterhead explaining why the area is needed<br>
• Display Work (poster / standee / promotional design)<br><br>

Faculty will review the request before forwarding it for administrative approval.
</div>
